...
/*   Updated: 2022/04/21 17:16:48 by tmartial         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const AForm& src) : _name(src._name), _signe(src._signe), _gradeSigned(src._gradeSigned), _gradeExe(src._gradeExe)
{
	std::cout << "Copy AForm constructor" << std::endl;
}

AForm::AForm(std::string name , bool signe, int gradeSigned, int gradeExe) : _name(name), _signe(signe), _gradeSigned(gradeSigned), _gradeExe(gradeExe)
{
